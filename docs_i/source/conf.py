...
htmlhelp_basename = 'MAWACEProjetPrvisionneldoc'
...
man_pages = [
    (master_doc, 'mawaceprojetprvisionnel', u'MAWACE : Projet Prévisionnel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MAWACEProjetPrvisionnel', u'MAWACE : Projet Prévisionnel Documentation',
     author, 'MAWACEProjetPrvisionnel', 'One line description of project.',
     'Miscellaneous'),
]
